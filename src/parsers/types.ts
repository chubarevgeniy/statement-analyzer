...
export interface ParsedTxn {
  ...
  /**
   * Стабильный идентификатор операции из самой выписки (напр. transaction_id в
   * CSV-экспорте Trade Republic). Если задан — используется как основа дедупликации
   * вместо эвристики по сумме/балансу/описанию.
   */
